...
let figuras = ["coração", "estrela", "ok", "joinha", "sorriso"];
...
console.log(figuras[1]); // estrela
console.log(figuras[5]); // undefined
...
for (let f in frutas) {  // Percorre os indices (se escrever frutas[f] ele lista as frutas)
    console.log(f);
}
